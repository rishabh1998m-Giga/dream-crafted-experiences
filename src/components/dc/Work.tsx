...
function Card({ project, i }: { project: Project; i: number }) {
  ...
  return (
    <article
      ref={ref}
      data-cursor="VIEW"
      className="group relative w-[82vw] shrink-0 sm:w-[52vw] lg:w-[34vw]"
    >
      <div className="relative overflow-hidden bg-ink-soft">
        <img
          ...
          width={1408}
          height={1760}
          className="aspect-[4/5] max-h-[500px] w-full object-cover transition-transform duration-[1400ms] ease-[cubic-bezier(.16,1,.3,1)] group-hover:scale-[1.06] lg:h-[58vh] lg:max-h-none lg:aspect-auto"
        />
